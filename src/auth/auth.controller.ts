...
export class AuthController {
  constructor(
    ...
    private readonly prisma: PrismaService, // 👈 ahora sí podemos inyectar
  ) {}

  // ✅ Versión Pro: Verificar token en Firebase y existencia en DB
  @Get('verify')
  @HttpCode(200)
  async verify(@Headers('authorization') authHeader: string) {
    ...
    // 🔎 Buscar al usuario en la tabla (asegúrate que tienes campo `uid`)
